...
def main():
    ...
    if not args.bandwidth >= 0:
        parser.error('The bandwidth must be non-negative.')
    ...
    # use gaussian kde to smooth the sc similar to cortical-cortical SC
    ...
    for i in range(n):
        ...
        # Python 3 port: fixed tab indentation (was tab/space mixed)
