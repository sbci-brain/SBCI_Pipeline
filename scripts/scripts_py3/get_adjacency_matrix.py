#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Python 3 port: np.bool → bool (removed in NumPy 1.24+)
...
def main():
    ...
    # Python 3 port: np.bool is removed in NumPy 1.24+; use bool instead
    result = np.zeros((lh_n + rh_n, lh_n + rh_n), bool)
