...
python /scratch/mcole22/sbc_pipeline/newscripts/downsample_surface.py \
...
python /scratch/mcole22/sbc_pipeline/newscripts/mesh_validation.py \
...
python /scratch/mcole22/sbc_pipeline/newscripts/map_surfaces.py \
       --lh_surface_hi out_surf/lh_white_s2w2.vtk \
       --lh_surface_lo ${OUTPUTDIR}/lh_white_${SIZE}.vtk \
       --rh_surface_hi out_surf/rh_white_s2w2.vtk \
       --rh_surface_lo ${OUTPUTDIR}/rh_white_${SIZE}.vtk \
...
python /scratch/mcole22/sbc_pipeline/newscripts/group_roi_vertices.py \
...
python /scratch/mcole22/sbc_pipeline/newscripts/group_roi_vertices.py \
       --lh_annot ../structure/t1_freesurfer/label/lh.aparc.2009s.annot \
       --rh_annot ../structure/t1_freesurfer/label/rh.aparc.2009s.annot \
       --mesh ${OUTPUTDIR}/mapping_${SIZE}.npz \
...
python /scratch/mcole22/sbc_pipeline/newscripts/snap_fibers.py \
...
python /scratch/mcole22/sbc_pipeline/newscripts/calculate_sc.py \
       --intersections ${OUTPUTDIR}/snapped_fibers_${SIZE}.npz \
       --mesh ${OUTPUTDIR}/mapping_${SIZE}.npz \
       --output ${OUTPUTDIR}/sc_${SIZE}.npz -f
 
# Step3) Calculate SC density
python /scratch/mcole22/sbc_pipeline/newscripts/calculate_density.py \
...
python /scratch/mcole22/sbc_pipeline/newscripts/calculate_fc.py \
...
python /scratch/mcole22/sbc_pipeline/newscripts/calculate_partial_fc.py \
       --lh_time_series ./fmcpr.sdf.sm5.self.lh.nii.gz \
       --rh_time_series ./fmcpr.sdf.sm5.self.rh.nii.gz \
       --mesh ${OUTPUTDIR}/mapping_${SIZE}.npz \
       --motion ./fmcpr.mcdat \
...
python /scratch/mcole22/sbc_pipeline/newscripts/calculate_partial_fc_with_global.py \
       --lh_time_series ./fmcpr.sdf.sm5.self.lh.nii.gz \
       --rh_time_series ./fmcpr.sdf.sm5.self.rh.nii.gz \
       --mesh ${OUTPUTDIR}/mapping_${SIZE}.npz \
       --motion ./fmcpr.mcdat \
...
python /scratch/mcole22/sbc_pipeline/newscripts/calculate_dst_mask.py \
       --lh_surface ${OUTPUTDIR}/lh_white_${SIZE}.vtk \
       --rh_surface ${OUTPUTDIR}/rh_white_${SIZE}.vtk \
       --mesh ${OUTPUTDIR}/mapping_${SIZE}.npz \
       --epsilon 5 \
