...
def _build_args_parser():
    ...
    p.add_argument('--resolution', action='store', metavar='RESOLUTION', required=True,
                   type=int, help='The resolution of the downsampled surfaces (.npz), 10*(4^n)+2.')
